export function project1Carousel() {
  const projectTrack = document.querySelector(".js-project1-carousel-track");
  const leftArrow = document.querySelector(".js-project1-carousel-left");
  const rightArrow = document.querySelector(".js-project1-carousel-right");
